...
//    Set<Facility> facility;
    ...
    public Room(RoomType roomType, String rules, BigDecimal pricePerDaily, BigDecimal pricePerWeekly, BigDecimal pricePerMonthly, Boolean isAvailable, Kost kost) {
