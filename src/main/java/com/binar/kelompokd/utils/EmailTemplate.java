...
public class EmailTemplate {
  ...
  public String getRegisterTemplate(){
    return "<!doctype html>\n" +
        ...
        "  </head>\n" +
        "  <body>\n" +
        "    <span class=\"preheader\">Hai {{USERNAME}}, Please Confirm your email here for Naqos App! </span>\n" +
  ...
  public String getResetPassword(){
    return "<!doctype html>\n" +
        ...
        "  </head>\n" +
        "  <body>\n" +
        "    <span class=\"preheader\">Hai {{USERNAME}}, Reset Your Password email here for Naqos App! </span>\n" +
        "    <table role=\"presentation\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"body\">\n" +
        "      <tr>\n" +
        "        <td>&nbsp;</td>\n" +
        "        <td class=\"container\">\n" +
